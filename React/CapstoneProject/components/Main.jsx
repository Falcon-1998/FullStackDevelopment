...
export default function  Main() {   
    ...
    const isLastGuessInCorrect = lastguessedLetter ? !currentWord.includes(lastguessedLetter) : null;
    ...
    const languages = ['HTML', 'CSS', 'Javascript', 'React', 'Typescript', 'Node.js', 'Python', 'Assembly'];
    const farewellText = wrongGuessCount > 0 ? getFarewellText(languages[wrongGuessCount - 1]) : '';
    return (
