// word.js - EXACTLY 500 common English words

const words: Array<string> = [
  'ability', 'able', 'about', 'above', 'accept', 'according', 'account', 'across', 'act', 'action',
  'activity', 'actually', 'add', 'address', 'administration', 'admit', 'adult', 'advance', 'advantage', 'advice',
  ...
  'anyone', 'anything', 'appear', 'apply', 'approach', 'area', 'area', 'arm', 'army', 'around',
  ...
  'begin', 'beginning', 'behavior', 'behind', 'believe', 'benefit', 'best', 'better', 'between', 'beyond',
  'big', 'bill', 'billion', 'bit', 'black', 'blood', 'blue', 'board', 'body', 'book',
  'born', 'both', 'box', 'boy', 'break', 'bring', 'brother', 'budget', 'building', 'business',
  ...
  'develop', 'development', 'die', 'difference', 'different', 'difficult', 'dinner', 'direction', 'director', 'dirt',
  'discuss', 'discussion', 'disease', 'do', 'doctor', 'dog', 'door', 'down', 'draw', 'dream',
  'drive', 'drop', 'drug', 'during', 'each', 'early', 'east', 'easy', 'eat', 'economic',
  'economy', 'edge', 'education', 'effect', 'effort', 'eight', 'either', 'election', 'elect', 'electricity',
  'element', 'else', 'employee', 'end', 'energy', 'enjoy', 'enough', 'enter', 'entire', 'environment',
  ...
  'fuel', 'full', 'fund', 'future', 'game', 'garden', 'gas', 'general', 'generation', 'get',
  ...
  'imagine', 'impact', 'important', 'improve', 'in', 'include', 'including', 'increase', 'indeed', 'independent',
  ...
  'join', 'just', 'keep', 'key', 'kid', 'kill', 'kind', 'kitchen', 'knew', 'know',
  'knowledge', 'land', 'language', 'large', 'last', 'late', 'later', 'laugh', 'law', 'lawyer',
  'lay', 'leader', 'learn', 'least', 'leave', 'left', 'leg', 'legal', 'less', 'let',
  ...
  'manager', 'many', 'market', 'marriage', 'material', 'math', 'matter', 'may', 'maybe', 'me',
  ...
  'other', 'others', 'our', 'out', 'outside', 'over', 'over', 'own', 'owner', 'page',
  ...
  'reveal', 'rich', 'ride', 'right', 'rise', 'risk', 'road', 'rock', 'role', 'room',
  ...
  'single', 'sink', 'sister', 'sit', 'site', 'situation', 'six', 'size', 'skill', 'skin',
  'small', 'smile', 'so', 'social', 'society', 'soldier', 'some', 'somebody', 'someone', 'something',
  'sometimes', 'son', 'song', 'soon', 'sort', 'sound', 'source', 'south', 'southern', 'space',
  'speak', 'special', 'species', 'specific', 'speech', 'spend', 'sport', 'spring', 'staff', 'stage',
...
export function getRandomWord() : string{
  ...
  return words[randomIndex].toUpperCase(); // Uppercase for hangman
}
export function getRandomIIndex<T>(arr :T[] ): number{
